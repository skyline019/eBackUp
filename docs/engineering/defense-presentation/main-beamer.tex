...
\begin{frame}{一句话定位}
  ...
  \begin{itemize}
    ...
    \item 233 gtest + L1--L7 bench 硬门禁
...
%--- 3 课程对照 ---
\begin{frame}{课程功能对照}
  \input{chapters/course-mapping-beamer.tex}
...
\begin{frame}{备份主路径}
  \resizebox{0.92\textwidth}{!}{%
    \input{chapters/figures-sequence-inner.tex}
  }
...
\begin{frame}{测试与门禁}
  \begin{itemize}
    \item \textbf{233} gtest + L1--L7 bench + powerfail + Rust IT
...
\begin{frame}{开发理念 vs 课程软件工程}
  \resizebox{0.88\textwidth}{!}{%
    \input{chapters/figures-adapt-loop-inner.tex}
  }
  \vspace{0.2em}
  \footnotesize
...
\begin{frame}{总结}
  \begin{enumerate}
    ...
    \item \textbf{工程}：宪法 + bench 门禁 + 233 测试
    \item \textbf{经历}：Wave5 正确性 / 3.2 剪枝 / Phase A 止损
