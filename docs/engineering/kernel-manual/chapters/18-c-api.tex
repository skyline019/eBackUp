\chapter{C API 与 ABI v29}
\label{ch:c-api}

\section{概述}

稳定 C API 定义于 \filepath{include/ebbackup/eb\_backup.h}，实现于 \filepath{src/engine/eb\_backup\_capi.cc}。当前 \texttt{EB\_BACKUP\_ABI\_VERSION = 29}。\versiontag{0.6.0}--\versiontag{0.9.4} 维持 v7--v12 兼容面；\versiontag{0.8+} 起能力 Wave 递增至 v29（见 \cref{ch:capability-waves}）。
