...
\textbf{当前交付指标}（Release Windows，\versiontag{0.9.5}）：C API ABI \textbf{v29}；ctest \textbf{363} gtest + C API + bench；L5 $\sim$170--172\,MB/s；L6 $\sim$186\,MB/s；L7 multi $\sim$646--658\,MB/s。能力 Wave A--T 见 \cref{ch:capability-waves} 与 \filepath{docs/WAVE\_ARCHIVE.md}。
