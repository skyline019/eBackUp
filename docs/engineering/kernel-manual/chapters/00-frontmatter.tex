...
本文档为 \textbf{ebbackup 备份内核}（目录 \filepath{engine\_cpp/}）与 \textbf{运维质量闭环}（bench L1--L7、compact/GC、363 项 gtest、C API ABI v29）的\textbf{完整扩写版}工程技术手册。
...
Part II 运维 & bench L1--L7、C API ABI v29、compact/GC、测试/CI \\
Part I 扩展 & 第 21 章能力 Wave A--T（ABI v14--v29） \\
