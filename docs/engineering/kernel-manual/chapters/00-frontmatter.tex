...
本文档为 \textbf{ebbackup 备份内核}（目录 \filepath{engine\_cpp/}）与 \textbf{运维质量闭环}（bench L1--L7、compact/GC、393 项 gtest、C API ABI v37）的\textbf{完整扩写版}工程技术手册。
...
\begin{itemize}[nosep]
  ...
  \item 流程图使用 TikZ；代码清单摘录以 commit \texttt{965431b}（\versiontag{0.9.5}）为准；
...
Part II 运维 & bench L1--L7、C API ABI v37、compact/GC、测试/CI \\
Part I 扩展 & 第 21 章 Wave A--T（ABI v14--v29）；第 22 章 Phase 16--19（ABI v33--v37） \\
附录 & 源码索引、术语表、环境变量、manifest v4/v5、Wave 演进、统计字段索引 \\
\bottomrule
\end{longtable}
...
2026-07-08 & v1.2 & 第 21 章能力 Wave A--T；C API 扩至 ABI v29；363 gtest；\filepath{docs/WAVE\_ARCHIVE.md} 交叉引用 \\
2026-07-08 & v1.3 & 第 21 章详实扩写：manifest v5/MBI/三路恢复/Hybrid CDC/插件/窗口 + TikZ 图例 \\
2026-07-09 & v1.4 & 第 22 章 Phase 16--19（稀疏/EFS/VSS/envelope/Webhook）；C API 扩至 ABI v37；393 gtest；Workbench IT 13 \\
\bottomrule
\end{longtable}
